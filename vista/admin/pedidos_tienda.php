        ...
        <div class="flex-grow-1">
            <nav class="navbar navbar-dark">
                <div class="container-fluid">
                    <span class="navbar-brand">Gestión de Pedidos en Tienda F&iacute;sica</span>
            ...
            <div class="main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="mb-0 mt-4">PEDIDOS EN TIENDA</h2>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover align-middle">
                        ...
                        <tbody>
                            <?php foreach ($pedidos_fisicos as $pedido): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php endif; ?> <button class="btn btn-sm btn-outline-danger mt-1"
