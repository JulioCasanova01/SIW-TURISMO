...
<body>
    ...
    <div id="carouselJYS" class="carousel slide container mt-5" data-bs-ride="carousel" interval="3000">
        <div class="carousel-inner rounded-4 shadow">
            ...
            <div class="carousel-item shadow">
                <img src="../../IMAGENES/aventura.gif" class="d-block w-100" alt="Aventura en movimiento">
                <div class="carousel-caption d-none d-md-block">
            ...
            <!-- Imagen -->
            <div class="carousel-item shadow">
                <img src="../../IMAGENES/playa.jpg" class="d-block w-100" alt="Playa paradisíaca">
                <div class="carousel-caption d-none d-md-block">
    ...
    <div class="container">
        <h1 class="titulo-principal">Nuestros Tours</h1>
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Tour Eje Cafetero</h5>
    ...
    <footer class="footer-jys mt-5">
        <div class="container">
            ...
            <div class="footer-bottom text-center">
                <p>&copy; 2025 JYS PROMOTORES DE VIAJES Y TURISMO.<br>Todos los derechos reservados.</p>
